...
public class AuthManager : MonoBehaviour
{
    ...
    private const string REFRESH_TOKEN_RESFS_KEY = "RefreshToken";
    ...
    private void SaveTokenToPrefs(string accessToken, string refreshToken, DateTime expiryTime)
    {
        ...
        PlayerPrefs.SetString(REFRESH_TOKEN_RESFS_KEY, refreshToken);
